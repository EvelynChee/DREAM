...
def parse_arguments():
    ...
    parser.add_argument("--lr", type=float, default=0.001, help="Learning rate.", nargs='+')
    parser.add_argument("--min-lr", type=float, default=0.0, help="Minimum learning rate.")
    ...
    parser.add_argument(
        ...
        type=str,
        default="finetune",
        choices=["finetune", "lwf", "ZSCL", "icarl", "ours", "ours_semi"],
        help="Method to use.",
    )
    parser.add_argument(
        "--train-mode",
    ...
    parser.add_argument("--few-shot", type=int, default=-1, help="few_shot_num")  # n-shot
