...
import torch
from torchvision.transforms import Compose, Resize, CenterCrop, ToTensor, Normalize, RandomResizedCrop, InterpolationMode, RandomHorizontalFlip
...
def _transform(n_px: int, is_train: bool):
    ...
    if is_train:
        return Compose([
            ...
            ToTensor(),
            normalize,
            RandomResizedCrop(n_px, scale=(0.9, 1.0), interpolation=InterpolationMode.BICUBIC, antialias=True),
